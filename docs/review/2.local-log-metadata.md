...
Questa è l'appendice della [tabella breve per la riunione](1.runtime-and-resource-summary.md). Contiene il dettaglio da consultare solo quando serve verificare una run.
