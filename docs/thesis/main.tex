% Original thesis template layout added in commit 0305464a (docs: add new thesis layout).
...
\usepackage{graphicx}
\graphicspath{{assets/icons/}{assets/img/}}
...
\input{Chapters/1_IntroductionAndMotivation} % Your work
\input{Chapters/2_Background} % Work done by others!
% \input{Chapters/RelatedWork} % Work done by others!
\input{Chapters/3_CodeAsIs}
% \input{Chapters/RequirementsAnalysis} % Your work
\input{Chapters/4_Improvements}
% \input{Chapters/Design} % Your work
% \input{Chapters/Implementation} % Your work
\input{Chapters/5_ExperimentalResults} % Your work
% \input{Chapters/Discussion} % Your work
\input{Chapters/6_ConclusionsAndFutureWork}  % Your work
\input{Chapters/7_Appendix}
% \input{Chapters/SelectedCodeFragments} % Your work
\nocite{*}
...
\input{Appendix/SelectedCodeFragments} % Your work
